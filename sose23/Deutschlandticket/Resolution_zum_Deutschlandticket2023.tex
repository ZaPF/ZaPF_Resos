...
Konferenz aller werkstofftechnischen und materialwissenschaftlichen Studiengänge und Konferenz der Informatikfachschaften}
...
\begin{table}[]
    ...
    \vspace{-2cm}
    \begin{tabular}{ccc}
         \includegraphics[width=165pt]{../Logo_KaWuM.png} & \includesvg[width=160pt]{../logo_KIF.svg} &  \includegraphics[width=75pt]{../logo.pdf}\\

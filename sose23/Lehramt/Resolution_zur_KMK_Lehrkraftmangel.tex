...
\cfoot{}
\lfoot{Zusammenkunft aller Physik-Fachschaften\\ Psychologie-Fachschaften-Konferenz}
\rfoot{www.zapfev.de, stapf@zapf.in\\konrat@psyfako.org}
...
\begin{table}[htb]
    ...
    \hspace{8cm}
    \begin{tabular}{cc}
         \multicolumn{1}{l}{\includegraphics[width=165pt]{../Logo_PsyFaKo.png}}  &  \includegraphics[width=75pt]{../logo.pdf}\\
         \multicolumn{1}{l}{Psychologie-Fachschaften-Konferenz} & Zusammenkunft aller & & Physik-Fachschaften 
    \end{tabular}
    \label{tab:logos1}
\end{table} 
...
Dem stimmen die ZaPF und die PsyFaKo explizit zu. MINT-Lehrkräfte sind häufig aufgrund %aufgrund des im Studium erworbenen Wissens 

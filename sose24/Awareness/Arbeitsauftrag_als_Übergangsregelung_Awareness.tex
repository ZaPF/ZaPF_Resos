...
\begin{center}
  \huge{Arbeitsauftrag als Übergangsregelung - Awareness}\vspace{.25\baselineskip}\\
  \normalsize
\end{center}
\vspace{1cm}
...
Die ZaPF wählt zwei Personen für die Dauer bis zur nächsten ZaPF. Die Wahl wird auf dieser ZaPF durchgeführt.
Die gewählten Personen werden mit der Durchführung der Aufgaben, wie sie in der geplanten Satzungsänderung geschrieben stehen, betraut.

Aufgabenbeschreibung aus der geplanten \href{https://github.com/ZaPF/Satzung_der_ZaPF/pull/33/commits/a6e4a9397412b2af548edcb5a27b0bd883b76832}{Satzungsänderung}:

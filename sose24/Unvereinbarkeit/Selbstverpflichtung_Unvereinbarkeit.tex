...
\begin{center}
  \huge{Selbstverpflichtung zur Unvereinbarkeit}\vspace{.25\baselineskip}\\
  \normalsize
\end{center}
\vspace{1cm}
...
Die ZaPF kooperiert nicht mit der sogenannten \glqq Alternative für Deutschland\grqq und anderen rechtsextremen Organisationen. Dies trifft auch auf alle Unterorganisationen, Nachfolgeorganisationen, assoziierte Organisationen, insbesondere Jugendorganisationen und Hochschulgruppen, sowie andere Organisationen zu, die mit der sogenannten \glqq AfD\grqq kooperieren. Weiter sieht die ZaPF davon ab, Kontakt mit diesen Organisationen aufzunehmen.

Eine Mitgliedschaft in einer dieser Organisationen ist mit der Mitgliedschaft in der ZaPF nicht vereinbar.
